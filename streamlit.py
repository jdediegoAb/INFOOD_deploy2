...
text='<p style="font-family:Arial Black; color:#1C5D70; font-size: 12px;">check out the whole list:</p>'
#letter color
#008A89 
#1C5D70
#2F4858
...
with columns[1]:
    ...
    df4=pd.DataFrame({'INPUT':df3.index,'COUNT':df3.values}).reset_index(drop=True)
    df5=df4.head(4)
    st.dataframe(df5)
